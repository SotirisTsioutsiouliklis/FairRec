#!/bin/bash
python3 experiment_two_acceptance.py -r 10 -s node2vec_scores.csv -n node2vec_scores.csv -o accept_prob_node2vec.csv
python3 experiment_two_acceptance.py -r 10 -s adamic_adar_scores.csv -n node2vec_scores.csv -o accept_prob_adamic_adar.csv

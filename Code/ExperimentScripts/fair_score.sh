#!/bin/bash
python3 experiment_one_fairness.py -r 10 -s node2vec_scores.csv -o sc_node2vec_scores.csv
python3 experiment_one_fairness.py -r 10 -s adamic_adar_scores.csv  -o sc_adamic_adar_scores.csv

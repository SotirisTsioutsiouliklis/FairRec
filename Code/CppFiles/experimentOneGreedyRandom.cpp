...
int main() {
    ...
    // Save logs.
    pagerank_algorithms::saveVector("redRatioGreedyRandomSources.txt", redRatioLog);
    pagerank_algorithms::saveVector("node2vecGreedyRandomSources.txt", node2vecLog);
    pagerank_algorithms::saveVector("resourceAllocationGreedyRandomSources.txt", resLog);
    pagerank_algorithms::saveVector("jaccardCoefficientGreedyRandomSources.txt", jaccLog);
    pagerank_algorithms::saveVector("prefferentialAttachmentGreedyRandomSources.txt", prefLog);
    pagerank_algorithms::saveVector("addamicAddarGreedyRandomSources.txt", adamAdarLog);
    pagerank_algorithms::saveVector("finalPagerankGreedyRandomSources.txt", pagerank);
    // Save selected edges.
    pagerank_algorithms::saveVector("edgesSelectedGreedyRandomSources.txt", newEdges);

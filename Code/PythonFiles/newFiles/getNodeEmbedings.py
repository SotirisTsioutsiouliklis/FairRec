...
Examples:
    the general syntax is the following:
        ...
        >>> python3 getNodeEmbeddings.py -g <graph file> -n <node file> -p <embedding policy> -o <output file>

        >>> python3 getNodeEmbeddings.py -g out_graph.txt -n random_nodes.csv -p node2vec -o random_node2vec_node_embeddings.csv
...
if __name__ == "__main__":
    ...
    if sys.argv[1] == "-g" and sys.arv[3] == "-n" and sys.argv[5] == "-p" and sys.argv[7] == "-o":

    ...
    if sys.argv[1] == '-s':
        for directory in directories:
            for i in range(10):
                ...
                subprocess.call(["cp ../../Executables/PythonFiles/getEdgeScores.py %s/network_%d" %(directory, i)], cwd=".", shell=True)
                subprocess.call(["python3 getEdgeScores.py"], cwd= "%s/network_%d" %(directory, i), shell=True)
    elif sys.argv[1] == '-r':
